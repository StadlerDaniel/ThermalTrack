...
class MotChallenge2DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            'SPLIT_TO_EVAL': 'train',  # Valid: 'train', 'val', 'test', 'all'
            ...
            'SEQMAP_FILE': '',  # Directly specify seqmap file (if none use seqmap_folder/benchmark-split_to_eval)
    ...
    def __init__(self, config=None):
        ...
        if self.config['SPLIT_TO_EVAL'] in ['val', 'split1', 'split2']:
        ...
        if self.config['TRACKER_SUB_FOLDER'] == 'None':
            self.config['TRACKER_SUB_FOLDER'] = False

        if self.config['TRACKER_SUB_FOLDER']:
